        ...
        <Col>
          ...
          <div className="container marketing">
            <div className="row text-center">
              ...
              <div className="col-lg-4">
                <svg className="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 140x140"><title>Technology</title><rect width="100%" height="100%" fill="#777" /><text x="50%" y="50%" fill="#777" dy=".3em">140x140</text></svg>
                <h2>Technology</h2>
            ...
            <div class="row featurette">
              <div class="col-md-7">
                ...
                <p class="lead">Previously, script-based meetings were accompanied with knowledge binder, laminated sheets so the next person that lead service could do so in a predictable way. These meetings relied on in-person participation, engagement and fellowship. Meeting growth varied depending on seasonal changes, scheduling with life events, and attendance based on location. Current health (pandemic) events require a need to adapt and a need for a modern digital solution. With the help of Zoom, a grass roots solution for those bold enough to make the technology leap, communities have ventured to online meetings. Initial review indicates that not all meetings have made this transfer, indicated by the updates made on public and existing websites, both local and regional. Some updated, others not. For those searching, finding outdated information is frustrating. As some independently run groups have better ideas than others, who could benefit from sharing these ideas, stories of recovery ? What if a speaker’s presentation was more widely available? How much impact would that have at a local level, at a community level, at a national level?</p>
              </div>
              <div class="col-md-5">
